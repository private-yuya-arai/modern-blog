...
\`\`\`mermaid\r
graph TD\r
    Prior["事前分布 P(θ)<br>「たぶんこんな感じかな？」<br>(主観や過去の知見)"]\r
    Data["データ D<br>「新しい事実を観測！」"]\r
    Likelihood["尤度 P(D|θ)<br>「このパラメータなら<br>データはこう出るはず」"]\r
    \r
    Prior & Data & Likelihood --> Posterior["事後分布 P(θ|D)<br>「データを見て考えが変わった！」<br>(更新された知識)"]\r
    \r
